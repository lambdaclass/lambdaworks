...
public:
  ...
  __device__ u128 operator*(const u128 rhs) const {
    ...
    // // unsigned long top[4] = {high >> 32, high & 0xffffffff, low >> 32, low
    // & 0xffffffff};
    // // unsigned long bottom[4] = {rhs.high >> 32, rhs.high & 0xffffffff,
    ...
    // unsigned long third32 = (products[0][2] & 0xffffffff) + (products[0][3]
    // >> 32); unsigned long second32 = (products[0][1] & 0xffffffff) +
    // (products[0][2] >> 32); unsigned long first32 = (products[0][0] &
    // 0xffffffff) + (products[0][1] >> 32);
