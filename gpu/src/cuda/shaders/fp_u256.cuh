...
private:
    ...
    __device__ constexpr static const constant u256 N = u256(N_0, N_1, N_2, N_3);
    __device__ constexpr static const constant u256 R_SQUARED = u256(R_SQUARED_0, R_SQUARED_1, R_SQUARED_2, R_SQUARED_3);
    __device__ constexpr static const constant u256 N_PRIME = u256(N_PRIME_0, N_PRIME_1, N_PRIME_2, N_PRIME_3);

    // Equates to `(1 << 256) - N`
    __device__ constexpr static const constant u256 R_SUB_N =
