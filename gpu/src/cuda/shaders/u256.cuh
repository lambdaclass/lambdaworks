...
public:
  ...
  __device__ u256 operator*(const u256 rhs) const {
    ...
    // u128 bottom[3] = {u128(rhs.high.low), u128(rhs.low.high),
    // u128(rhs.low.low)};
    // // u128 top[4] = {high >> 32, high & 0xffffffff, low >> 32, low &
    // 0xffffffff};
    // // u128 bottom[4] = {rhs.high >> 32, rhs.high & 0xffffffff, rhs.low >>
    // 32, rhs.low & 0xffffffff};
    // // u128 products[4][4];
    ...
    // return u256(u128(first64.low, second64.low), u128(third64.low,
    // fourth64.low));
