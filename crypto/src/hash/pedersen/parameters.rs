...
const fn from_affine_unchecked(
    x_hex: &str,
    y_hex: &str,
) -> ShortWeierstrassProjectivePoint<StarkCurve> {
    ShortWeierstrassProjectivePoint::<StarkCurve>::new([
...
const fn shift_point() -> ShortWeierstrassProjectivePoint<StarkCurve> {
    from_affine_unchecked(
...
const fn points_p1() -> [ShortWeierstrassProjectivePoint<StarkCurve>; 930] {
    [
        from_affine_unchecked(
...
const fn points_p2() -> [ShortWeierstrassProjectivePoint<StarkCurve>; 15] {
    [
        from_affine_unchecked(
...
const fn points_p3() -> [ShortWeierstrassProjectivePoint<StarkCurve>; 930] {
    [
        from_affine_unchecked(
...
const fn points_p4() -> [ShortWeierstrassProjectivePoint<StarkCurve>; 15] {
    [
        from_affine_unchecked(
