...
{
    if round == 0 {
        println!("poly has {} variables", poly.n_vars);
...
mod test_prover {
    ...
    fn test_sumcheck_initial_value() {
        ...
        let poly = MultilinearPolynomial::new(vec![constant]);
        ...
        assert_eq!(msg, FieldElement::<Babybear31PrimeField>::from(1));
    }
}
