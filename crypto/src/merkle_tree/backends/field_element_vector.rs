...
mod tests {
    ...
    fn hash_data_field_element_backend_works_with_sha3_256() {
        ...
        let merkle_tree = MerkleTree::<FieldElementVectorBackend<F, Sha3_256, 32>>::build(&values).unwrap();
    ...
    fn hash_data_field_element_backend_works_with_sha3_512() {
        ...
        let merkle_tree = MerkleTree::<FieldElementVectorBackend<F, Sha3_512, 64>>::build(&values).unwrap();
        let proof = merkle_tree.get_proof_by_pos(0).unwrap();
    ...
    fn hash_data_field_element_backend_works_with_keccak512() {
        ...
        let merkle_tree = MerkleTree::<FieldElementVectorBackend<F, Keccak512, 64>>::build(&values).unwrap();
        let proof = merkle_tree.get_proof_by_pos(0).unwrap();
    ...
    fn hash_data_field_element_backend_works_with_sha2_512() {
        ...
        let merkle_tree = MerkleTree::<FieldElementVectorBackend<F, Sha512, 64>>::build(&values).unwrap();
        let proof = merkle_tree.get_proof_by_pos(0).unwrap();
