...
// - With 256 bit
pub type Sha3_256Backend<F> = Backend<F, Sha3_256, 32>;
pub type Keccak256Backend<F> = Backend<F, Keccak256, 32>;
pub type Sha2_256Backend<F> = Backend<F, Sha256, 32>;

// - With 512 bit
pub type Sha3_512Backend<F> = Backend<F, Sha3_512, 64>;
pub type Keccak512Backend<F> = Backend<F, Keccak512, 64>;
pub type Sha2_512Backend<F> = Backend<F, Sha512, 64>;
