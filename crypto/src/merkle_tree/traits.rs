...
pub trait IsMerkleTreeBackend: Default {
    ...
    /// This function takes a single variable `Data`
    /// and converts it to a node
    fn hash_data(&self, leaf: &Self::Data) -> Self::Node;

    /// This function that takes the list of data from
    /// which the Merkle tree will be built from and
    /// converts it to a list of leaf nodes 
    ...
    /// This function takes to children nodes and build a new parent node.
