    ...
    "Benchmark": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "9f666ae5557412db5d8a6582ceed36eb027b5f01",
          "message": "Feat/goldilocks hybrid and bowers fft (#1104)\n\n* feat(math): Add hybrid Goldilocks field and Bowers FFT implementation\n\nAdd optimized implementations based on comprehensive benchmarking analysis:\n\nGoldilocks Hybrid Field (goldilocks_hybrid.rs):\n- Combines best operations from multiple analyzed implementations\n- add/sub: Original approach with simpler overflow handling (1.42x vs Plonky3)\n- mul/square: Optimized reduce_128 (3.66x and 4.45x vs Plonky3)\n- neg: Direct approach without intermediate canonicalization (1.70x vs Plonky3)\n- inv: Optimized addition chain (1.06x vs Plonky3)\n- Includes quadratic extension field (Fp2)\n\nBowers FFT (bowers_fft.rs):\n- Implements Bowers G network with improved twiddle access patterns\n- Structure of Arrays (SoA) support for batch processing\n- Multi-layer butterfly fusion for reduced memory traffic\n- Parallel implementation for large inputs\n- Benchmarks show 29-32% speedup over standard NR radix-2 FFT\n\nBenchmarks (criterion_goldilocks_hybrid.rs):\n- Field operation comparison: Original vs Hybrid\n- FFT comparison: Standard NR vs Bowers vs Bowers Fused\n\nBased on analysis from Plonky3 and empirical benchmarking studies.\n\n* style: Apply cargo fmt and fix clippy warnings\n\n* fix: Address PR review comments and consolidate Goldilocks implementation\n\nChanges:\n- Fix Bowers FFT parallel processing: replace invalid chunks_mut().collect()\n  with par_chunks_mut() for proper rayon parallelization\n- Remove redundant goldilocks_hybrid.rs since u64_goldilocks_field.rs already\n  has the optimized implementation with correct negation handling\n- Simplify benchmark to focus on FFT comparison (Standard NR vs Bowers)\n- The Bowers Fused FFT shows comparable performance to Standard NR FFT\n\nThe u64_goldilocks_field.rs now serves as the single optimized Goldilocks\nimplementation with:\n- Fast reduce_128 for multiplication/squaring\n- Correct negation with canonicalization to handle edge cases\n- Optimized addition chain for inversion\n\n* fix: Add alloc imports for no-std compatibility in bowers_fft tests\n\n* fix: Address clippy warnings in naive_dft test helper\n\n* fix: Replace silent twiddle fallbacks with debug_assert for fail-fast behavior\n\n- Replace if-else fallback to twiddles[0] with debug_assert! bounds checks\n- Replace modulo operations with direct indexing and debug_assert!\n- This ensures bugs are caught during development rather than silently producing incorrect results\n\n* improve Bowers FFT\n\n* remove unused Bowers implementations\n\n* addres PR comments\n\n* resolve comments\n\n* add proptest and native comparison tests for Bowers FFT\n\n* add size 1 edge case test\n\n---------\n\nCo-authored-by: jotabulacios <jbulacios@fi.uba.ar>",
          "timestamp": "2026-01-30T17:50:35-03:00",
          "tree_id": "03008bd988f3bab66a3f81b8e2bdefe253cb3147",
          "url": "https://github.com/lambdaclass/lambdaworks/commit/9f666ae5557412db5d8a6582ceed36eb027b5f01"
        },
        "date": 1769807718900,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "8ddf400273ac25519107dfbd760392992a0b57b6",
          "message": "Ignore slow tests (#1117)\n\n* ignore slow tests in gurusami sudan\n\n* remove time",
          "timestamp": "2026-01-30T19:36:53-03:00",
          "tree_id": "8bc1c11ed00f1d1cc47e2bc0a983419ed4ac773c",
          "url": "https://github.com/lambdaclass/lambdaworks/commit/8ddf400273ac25519107dfbd760392992a0b57b6"
        },
        "date": 1769814088722,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "1d465ae0f759a7faeab908aa6231d6b85c40d0a7",
          "message": "fix(stark): Add critical input validation and fix security calculations (#1095)\n\n* fix(stark): Add critical input validation and fix security calculations\n\n**grinding.rs:**\n- Validate grinding_factor is at most 63 to prevent shift overflow\n  (`1 << (64 - grinding_factor)` would overflow for values > 63)\n- Handle grinding_factor = 0 as \"no PoW requirement\" (always valid)\n- Add tests for boundary conditions\n\n**transcript.rs:**\n- Add zero guard for sample_u64 to prevent division by zero panic\n- Implement proper rejection sampling to eliminate modulo bias\n- Use fast masking path for power-of-two bounds\n- Add tests for new validation\n\n**domain.rs:**\n- Validate trace_length is a positive power of two (required for FFT)\n- Return ProvingError::InvalidTraceLength for invalid lengths\n- trailing_zeros() only gives correct log2 for powers of two\n\n**prover.rs:**\n- Add InvalidTraceLength error variant\n- Validate number_of_parts > 0 before breaking composition polynomial\n- Add bounds checking in commit_composition_polynomial:\n  - Check for empty input\n  - Validate all parts have same length\n  - Ensure LDE length is even for chunking\n- Use chunks_exact(2) instead of chunks(2) for safety\n\n**options.rs:**\n- Fix security calculation: use trailing_zeros() (= log2 for powers of 2)\n  instead of leading_zeros() which gave wrong results\n- Add validation that blowup_factor is a power of two >= 2\n- Add InvalidBlowupFactor error variant\n\n* validate blowup_factor in new_with_checked_security\n\n* Fix undefined variable after merge\n\n---------\n\nCo-authored-by: jotabulacios <jbulacios@fi.uba.ar>\nCo-authored-by: Nicole Graus <nicole.graus@lambdaclass.com>",
          "timestamp": "2026-02-02T15:06:09Z",
          "tree_id": "d96348305a179dc3181c564e2ee75852007d4332",
          "url": "https://github.com/lambdaclass/lambdaworks/commit/1d465ae0f759a7faeab908aa6231d6b85c40d0a7"
        },
        "date": 1770046719085,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "b1032ad71e46373068d22651d816a66d6ea9f955",
          "message": "feat(math): Add Goldilocks hybrid field implementation (#1112)\n\n* feat(math): Add Goldilocks hybrid field implementation\n\nThis adds a hybrid implementation of the u64 Goldilocks field that combines\nthe best operations from different optimization approaches:\n\n- mul/square: Optimized implementation (55-56% faster than Plonky3)\n- inv: Optimized implementation (3% faster than Plonky3)\n- pow: Diego's addition chain (19% faster than Plonky3)\n- add/sub: Original implementation (~20% faster)\n\nAlso includes quadratic extension field support and comprehensive tests.\n\n* Update u64_goldilocks_hybrid_field.rs\n\n* Remove broken pow\n\n* fix clippy\n\n* Fix inv() zero check uses canonical form\n\n* add benches\n\n* optimize hybrid and its extension\n\n* fix fmt and clippy\n\n---------\n\nCo-authored-by: Nicole Graus <nicole.graus@lambdaclass.com>\nCo-authored-by: jotabulacios <jbulacios@fi.uba.ar>",
          "timestamp": "2026-02-02T15:36:58Z",
          "tree_id": "f2c6135bd9777e166eada7bb016392f1569dcd6b",
          "url": "https://github.com/lambdaclass/lambdaworks/commit/b1032ad71e46373068d22651d816a66d6ea9f955"
        },
        "date": 1770048582081,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": false,
          "id": "e7ef4d9487991ce0ab763be91570197e6d525517",
          "message": "Use const bounds in multiplication for LLVM loop unrolling (#1108)\n\n* Use const bounds in multiplication for LLVM loop unrolling\n\nRefactors UnsignedInteger multiplication to use compile-time constant\nbounds instead of runtime bounds scanning, enabling LLVM loop unrolling\nfor approximately 2x performance improvement.\n\nAlgorithm changes:\n- Loops now iterate over fixed 0..NUM_LIMBS range\n- Guard condition `if i + j < NUM_LIMBS` determines which products are accumulated\n- Overflow products are discarded, implementing wrapping semantics\n\nThis aligns with standard cryptographic library conventions where field\noperations should never overflow during correct usage.\n\nAdds comprehensive multiplication tests covering:\n- Identity and zero properties\n- Commutativity and distributivity\n- Powers of two and limb boundaries\n- Different trait variants\n- Wrapping behavior on overflow\n\nBased on PR #1065 optimization approach.\n\n* Address reviewer feedback: add debug-mode overflow detection\n\n- Add comprehensive documentation explaining overflow behavior:\n  - Debug builds: overflow detected via debug_assert\n  - Release builds: wrapping semantics for performance\n  - Recommend UnsignedInteger::mul for non-field-arithmetic use cases\n\n- Add debug-only overflow detection that catches:\n  - Non-zero products that would exceed NUM_LIMBS\n  - Non-zero carry left after processing each column\n\n- Update tests to expect panic on overflow in debug mode\n- Fix clippy warning about unused initial value\n- This addresses the reviewer concern about silent wrapping masking bugs\n\n* style: Apply cargo fmt\n\n* fix: Remove unnecessary clone() calls on Copy types\n\n* add warning and checked_mul for wrap on overflow\n\n* fix misleading comment (carry position)\n\n---------\n\nCo-authored-by: Nicole <nicole.graus@lambdaclass.com>\nCo-authored-by: jotabulacios <jbulacios@fi.uba.ar>",
          "timestamp": "2026-02-02T16:03:13Z",
          "tree_id": "e07f47612722dd34668a592ad8723bb4bdd5d721",
          "url": "https://github.com/lambdaclass/lambdaworks/commit/e7ef4d9487991ce0ab763be91570197e6d525517"
        },
        "date": 1770050152972,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "9fc854148ff28246ff1310470c7dc7d55236ecb1",
          "message": "Fix/error handling cleanup (#1116)\n\n* fix(error-handling): Replace panics and unsafe unwraps with proper error handling\n\n- Add DivisionByZero and InverseOfZero variants to FFTError\n- Replace panicking From<FieldError> impl with proper error conversion\n- Remove unsafe unwrap_unchecked() in STARK constraint evaluation\n- Replace .unwrap() calls with descriptive expect() messages\n- Use ? operator for proper error propagation in Result-returning functions\n- Fix bug in std::error::Error impl for FFTError (missing variable binding)\n\n* fix(error-handling): Improve error handling in KZG, transcript, and transition constraints\n\n- KZG: Add bounds checking for deserialization with proper error propagation\n- Transcript: Replace .unwrap() with descriptive .expect() for U256 conversions\n- Transition: Replace all .unwrap() calls with descriptive .expect() messages\n  - Primitive root lookups\n  - Batch inverse operations\n  - FFT polynomial evaluations\n  - Option unwraps with documented invariants\n\n* fix(error-handling): Replace unwraps with descriptive expects in core modules\n\n- Elliptic curve point.rs: Add safety comments for z.inv() after zero check\n- Grinding: Document slice size guarantees for Keccak256 digest conversions\n- Multi-table prover: Document Option invariant after non-empty check\n- Trace: Document FFT interpolation preconditions for column lengths\n\n* fix fmt and clippy\n\n---------\n\nCo-authored-by: Nicole <nicole.graus@lambdaclass.com>",
          "timestamp": "2026-02-03T10:23:05-03:00",
          "tree_id": "0e9b24f85d4f761ae48c7780803eb8d61559a243",
          "url": "https://github.com/lambdaclass/lambdaworks/commit/9fc854148ff28246ff1310470c7dc7d55236ecb1"
        },
        "date": 1770126458951,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "bb748ea217ee5288cd1fc14f419443db78b53b80",
          "message": "feat(examples): Add BLS signatures example (#1113)\n\n* feat(examples): Add BLS signatures example\n\nThis adds a complete BLS (Boneh-Lynn-Shacham) signature implementation using\nthe BLS12-381 curve with support for:\n\n- Basic signing and verification using pairings\n- Signature aggregation (N signatures -> 1 signature)\n- Public key aggregation\n- Batch verification for multiple message/signature pairs\n\nThe implementation includes comprehensive tests demonstrating:\n- Single signer sign/verify\n- Multi-party signature aggregation\n- Three-party aggregation\n- Batch verification with different messages\n\nNote: This is an educational implementation. Production use should follow\nIETF standards for hash-to-curve (RFC 9380) and include proof-of-possession\nto prevent rogue key attacks.\n\n* fix(bls-signature): Address PR #1113 review comments\n\nFixes based on PR review feedback:\n\n1. hash_to_g2: Properly hash to base field (Fp), not scalar field (Fr)\n   - Expand message to 96 bytes using SHA3 with domain separation\n   - Interpret as Fp element (384-bit base field)\n   - Convert to scalar for G2 generator multiplication\n   - Uses full hash output - no truncation/collision vulnerability\n\n2. to_bytes: Fix potential panic on byte array access\n   - Use .last().unwrap_or(false) for safe access\n\n3. Remove unused rand dependency from Cargo.toml\n\n4. Add BlsError::LengthMismatch for batch_verify array mismatch\n   - Previously incorrectly returned EmptyInput\n\n5. from_seed: Fix secret key bias using SHA3-512\n   - XOR two 32-byte halves for uniform field sampling\n\n6. fp2_sqrt: Replace .unwrap() with .ok()? for graceful handling\n\nNote: Full RFC 9380 SSWU map implementation kept as reference code\nfor educational purposes. The current implementation is cryptographically\nsound for BLS signatures (collision-resistant) but doesn't provide\nfull indistinguishability from random points.\n\nCo-Authored-By: Claude Opus 4.5 <noreply@anthropic.com>\n\n* refactor(bls-signature): Extract hash_to_curve module with proper 96-byte hashing\n\n- Create dedicated hash_to_curve.rs module for hash-to-G2 implementation\n- Use 96 bytes (proper Fp2 size) instead of 64 bytes for base field hashing\n- Remove dead code from bls.rs (hash_bytes_to_fp2, bytes_to_hex, map_to_g2,\n  fp2_sqrt, clear_cofactor_g2)\n- Include SSWU map components for educational purposes (used in tests)\n- Export hash_to_g2 from lib.rs for external use\n\nCo-Authored-By: Claude Opus 4.5 <noreply@anthropic.com>\n\n* fix(bls-example): Address PR review feedback\n\n- Improve to_bytes() documentation with production serialization notes\n- Replace unwrap_or() with expect() for clearer error handling\n- Add descriptive messages to SSWU map expect() calls explaining invariants\n- Clarify that Fp element serialization is never empty\n\n* style: Apply cargo fmt formatting\n\n* Update examples/bls-signature/src/hash_to_curve.rs",
          "timestamp": "2026-02-03T11:50:58-03:00",
          "tree_id": "160ad8fc2e20cadf744e9da52eb3d4e0c13a6075",
          "url": "https://github.com/lambdaclass/lambdaworks/commit/bb748ea217ee5288cd1fc14f419443db78b53b80"
        },
        "date": 1770132379143,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "1aa37a2fca2d7642a17918d896ddceebb1623e43",
          "message": "feat(math): Add x86-64 assembly optimizations for field arithmetic (#1127)\n\n* feat(math): Add x86-64 assembly optimizations for field arithmetic\n\nAdd x86-64 inline assembly implementations for:\n\nMontgomery multiplication:\n- CIOS algorithm for 4-limb (256-bit) and 6-limb (384-bit) fields\n- Optimized version with spare bit optimization (EdMSM Algorithm 2)\n- Modular addition and subtraction with carry/borrow chains\n\nGoldilocks field (p = 2^64 - 2^32 + 1):\n- Optimized add/sub using carry flag and CMOV\n- Fast multiplication using MUL instruction with specialized reduction\n\nAll implementations use inline asm! blocks with proper register constraints\nand follow the existing aarch64 assembly patterns. Dispatch logic updated\nin montgomery_backed_prime_fields.rs to use x86_64 assembly when available.\n\nPerformance: Expected 30-70% improvement for Montgomery operations and\n10-30% for Goldilocks operations based on similar optimizations in\narkworks and plonky3.\n\nTested under Rosetta 2 on Apple Silicon - all field tests pass.\n\n* fix(math): Fix x86-64 Goldilocks asm and add documentation\n\n- Fix add_asm bug: use 'mov' instead of 'xor' to preserve carry flag\n  XOR clears CF which broke the conditional EPSILON addition logic\n- Add design documentation explaining hybrid asm/Rust approach for CIOS\n\nAddresses PR review feedback from Greptile (P0 critical bug).\n\n* test(math): Add differential fuzzing for x86-64 assembly\n\nAdd property-based tests using proptest to verify x86-64 assembly\nimplementations match pure Rust behavior:\n\nGoldilocks field (10,000 cases each):\n- add_asm vs Rust reference\n- sub_asm vs Rust reference\n- mul_asm vs Rust reference\n- square_asm consistency\n\nMontgomery operations (1,000 cases each):\n- add_4_limbs_asm and add_6_limbs_asm\n- sub_4_limbs_asm and sub_6_limbs_asm\n- cios_4_limbs and cios_6_limbs\n\nAlso includes edge case tests for boundary values (overflow, underflow,\ncarry propagation, modulus boundaries).\n\nRun with: cargo test --features asm,proptest --target x86_64-apple-darwin\n\n* perf(asm): Add MULX-based optimizations for x86-64\n\n- Add mul_asm_mulx for Goldilocks (BMI2, doesn't clobber flags)\n- Add dedicated square_asm for Goldilocks instead of delegating to mul\n- Add cios_4_limbs_mulx and cios_6_limbs_mulx for Montgomery (BMI2)\n- Improve mul_asm comments explaining Goldilocks reduction\n- Use mov with register instead of immediate 0 for flag preservation\n\nMULX advantages:\n- Doesn't clobber CPU flags, allowing better instruction scheduling\n- Explicit output registers (not hardcoded to rdx:rax)\n- Can be interleaved with add/adc chains more efficiently\n\nThese optimizations are available when compiling with target-feature=+bmi2\n(Intel Haswell 2013+, AMD Excavator 2015+).\n\n* Optimize Goldilocks asm with SBB trick and hybrid mul/square\n\n* disable x86-64 assembly for 6-limb fields\n\n* addres PR comments\n\n---------\n\nCo-authored-by: jotabulacios <jbulacios@fi.uba.ar>",
          "timestamp": "2026-02-03T15:08:38-03:00",
          "tree_id": "dcc1392a6b40e6ccb927e71b6e2f961aec305c15",
          "url": "https://github.com/lambdaclass/lambdaworks/commit/1aa37a2fca2d7642a17918d896ddceebb1623e43"
        },
        "date": 1770143605527,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "71f7ec463cb4498215d758abe86c40ab68802937",
          "message": "feat(polynomial): enhance multilinear polynomial operations (#1122)\n\n* feat(polynomial): enhance multilinear polynomial operations\n\nAdd key operations for modern proof systems that rely on multilinear\npolynomials:\n\n- partial_evaluate: Fix any variable (not just first) to a value\n- partial_evaluate_many: Fix multiple variables at once efficiently\n- batch_evaluate: Evaluate at multiple points with parallelism support\n- tensor_product: Kronecker product of two multilinear polynomials\n- eq_polynomial: Construct the equality polynomial eq(x, r)\n- eq_eval: Efficiently evaluate eq(x, r) at a single point\n- from_evaluations: Alias for new() with better documentation\n\nThese operations are essential for:\n- Sumcheck protocol (partial evaluation per round)\n- GKR protocol (eq polynomial for sum reduction)\n- Spartan, Hyrax, Ligero provers\n- Lasso/Jolt lookup arguments\n\nAll functions include mathematical documentation with references to\nThaler's \"Proofs, Arguments, and Zero-Knowledge\" and related papers.\n\nIncludes comprehensive tests for correctness and algebraic properties.\n\n* fix(multilinear): Add re-export docs and fix clippy clone_on_copy warnings\n\n- Add documentation for DenseMultilinearPolynomial, eq_eval, and\n  eq_polynomial re-exports in mod.rs\n- Remove unnecessary .clone() calls on Copy types in test code\n\n* style: Fix cargo fmt formatting in multilinear tests",
          "timestamp": "2026-02-04T09:54:41-03:00",
          "tree_id": "af5726a73389358a09ee9f9c420ba30caf65fa80",
          "url": "https://github.com/lambdaclass/lambdaworks/commit/71f7ec463cb4498215d758abe86c40ab68802937"
        },
        "date": 1770211150557,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "b8e1aa3ef00df837d1bfc3244262063951c43b6a",
          "message": "refactor(field): Rename representative to canonical (#1130)\n\n* refactor(field): Rename representative to canonical\n\nRenames the IsPrimeField trait method and associated type to better\nreflect their purpose:\n\n- `RepresentativeType` -> `CanonicalType`\n- `representative()` -> `canonical()`\n- `RepresentativeOutOfRange` -> `CanonicalValueOutOfRange`\n\nThis aligns with the Goldilocks field naming convention where\n`canonicalize` is used to convert values to their canonical form\nin range [0, p-1].\n\nChanges across:\n- IsPrimeField trait definition\n- All IsPrimeField implementations (Goldilocks, Mersenne31, P448, etc.)\n- FieldElement::canonical() method\n- All usages in crypto, provers, and examples\n\nNote: winterfell_adapter uses external git dependency that still has\nthe old API, so it retains the `representative` call.\n\n* fix clipppy\n\n* complete renaming\n\n---------\n\nCo-authored-by: jotabulacios <jbulacios@fi.uba.ar>",
          "timestamp": "2026-02-04T11:33:30-03:00",
          "tree_id": "300d5bf793b8f28d3257d628c66fbef47be7834c",
          "url": "https://github.com/lambdaclass/lambdaworks/commit/b8e1aa3ef00df837d1bfc3244262063951c43b6a"
        },
        "date": 1770217066724,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "939a0a36438bd0aa3eaeaa2649032eeaf63bfd9f",
          "message": "fix(plonk): add critical proof element validation checks (#1126)\n\n* fix(plonk): add critical proof element validation checks\n\nThis commit adds essential security validation for PLONK proof elements\nthat was previously missing (see TODO at verifier.rs:77).\n\nChanges:\n- Add VerifierError enum with variants for PointNotOnCurve,\n  PointNotInSubgroup, and InvalidFieldElement\n- Add IsValidProofCommitment trait for validating commitment elements\n- Implement IsValidProofCommitment for BLS12-381 Jacobian points using\n  the efficient endomorphism-based subgroup check\n- Add validate_proof_elements() function that validates all 9 G1\n  commitments in a PLONK proof\n- Add verify_with_validation() method for secure verification of\n  untrusted proofs\n- Keep existing verify() method for backward compatibility with\n  trusted proofs\n- Add comprehensive tests for validation functionality\n\nSecurity implications:\nWithout these checks, a malicious prover could submit points that are:\n1. Not on the elliptic curve - could cause undefined behavior in\n   pairing operations\n2. On the curve but not in the prime-order subgroup - breaks the\n   security assumptions of pairing-based verification (BLS12-381\n   has cofactor > 1)\n\nThe subgroup check uses the efficient phi(P) = -u^2*P verification\nfrom https://eprint.iacr.org/2022/352.pdf Section 4.3.\n\n* Add verification key validation\n\n---------\n\nCo-authored-by: Nicole Graus <nicole.graus@lambdaclass.com>",
          "timestamp": "2026-02-04T11:34:40-03:00",
          "tree_id": "08b0f0b4ab3a56de1d694e68c23153d5047b6f14",
          "url": "https://github.com/lambdaclass/lambdaworks/commit/939a0a36438bd0aa3eaeaa2649032eeaf63bfd9f"
        },
        "date": 1770217149386,
        "tool": "cargo",
        "benches": [
