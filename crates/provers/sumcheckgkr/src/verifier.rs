...
//     F::BaseType: Send + Sync,
//     FieldElement<F>: ByteConversion + Clone + Mul<Output = FieldElement<F>>,
// {
//     num_vars: usize,
//     round: usize,
...
//     oracle_factors: Vec<DenseMultilinearPolynomial<F>>,
//     mut transcript: DefaultTranscript<F>,
...
//     transcript.append_field_element(&FieldElement::from(oracle_factors.len() as u64));
