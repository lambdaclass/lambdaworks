// use crate::{sum_product_over_suffix, GKRPoly};
...
//         // The degree of g_j is at most the number of factors. QUESTION: WHY??
//         let num_eval_points = 4; // I CHANGED IT
//         let mut evaluation_points_x = Vec::with_capacity(num_eval_points); // [_, _, _]
//         let mut evaluations_y = Vec::with_capacity(num_eval_points); // [_, _, _]

//         // Prefix for evaluation points: (r1, r2, ..., r_{j-1}, eval_point_x)
//         let mut current_point_prefix = self.challenges.clone(); // []
//         current_point_prefix.push(FieldElement::zero()); // [0]

//         for i in 0..num_eval_points {
//             // i = 0,1, 2
//             // Point at which to evaluate X_j
//             let eval_point_x = FieldElement::from(i as u64);
//             evaluation_points_x.push(eval_point_x.clone()); //  i = 0: [0]. i = 1: [0, 1]. i = 2: [0, 1, 2]

//             // Set the actual value for X_j in the prefix
//             *current_point_prefix.last_mut().unwrap() = eval_point_x; // [i]
...
//             if i == 2 {
//                 println!("evaluation points x: {:?}", evaluation_points_x);
//                 println!("evaluations y: {:?}", evaluations_y);
//             }
//         }
...
// pub fn prove<F>(poly: GKRPoly<F>, transcript: &mut DefaultTranscript<F>) -> ProverOutput<F>
// where
...
//     transcript.append_field_element(&FieldElement::from(factors.len() as u64));
...
//             if j == 0 {
//                 challenge = FieldElement::from(3);
//             }
//             if j == 1 {
//                 challenge = FieldElement::from(2);
//             }
//             if j == 2 {
//                 challenge = FieldElement::from(4);
//             }
//             if j == 3 {
//                 challenge = FieldElement::from(7);
//             }

//             challenges.push(challenge.clone());
//             current_challenge = Some(challenge);

//             println!("challenge: {:?}", current_challenge);
//         } else {
...
//     Ok((claimed_sum, proof_polys, challenges))
// }
