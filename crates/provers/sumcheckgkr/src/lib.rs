...
//         let mut transcript_prover = DefaultTranscript::<F>::default();
//         let mut transcript_verifier = DefaultTranscript::<F>::default();

//         let prove_result = prove(vec![poly.clone()], &mut transcript_prover);

//         let (claimed_sum, proof_polys, _) = prove_result.unwrap();
...
//         let mut transcript_prover = DefaultTranscript::<F23>::default();
//         let mut transcript_verifier = DefaultTranscript::<F23>::default();
