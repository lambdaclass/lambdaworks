//! External comparison benchmarks: Lambdaworks vs Arkworks (BN254 MSM)
//!
...
// Arkworks
use ark_bn254::{Fr as ArkFr, G1Affine as ArkG1Affine, G1Projective as ArkG1};
...
pub fn bench_lambdaworks(c: &mut Criterion) {
    let mut group = c.benchmark_group("BN254 MSM Lambdaworks");
...
pub fn bench_arkworks(c: &mut Criterion) {
    let mut group = c.benchmark_group("BN254 MSM Arkworks");
