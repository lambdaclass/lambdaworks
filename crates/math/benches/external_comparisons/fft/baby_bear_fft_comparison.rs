//! External comparison benchmarks: Lambdaworks vs Plonky3 (BabyBear FFT)
//!
//! Compares FFT performance on BabyBear field:
...
pub fn bench_lambdaworks(c: &mut Criterion) {
    let mut group = c.benchmark_group("BabyBear FFT Lambdaworks");
...
pub fn bench_plonky3(c: &mut Criterion) {
    let mut group = c.benchmark_group("BabyBear FFT Plonky3");
