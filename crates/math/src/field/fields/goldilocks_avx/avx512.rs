...
mod proptest_tests {
    ...
    proptest! {
        ...
        #[test]
        fn add_matches_scalar(a in any::<[u64; 8]>(), b in any::<[u64; 8]>()) {
            let packed_a = PackedGoldilocksAVX512::from_u64_array(a);
            let packed_b = PackedGoldilocksAVX512::from_u64_array(b);
        ...
        #[test]
        fn sub_matches_scalar(a in any::<[u64; 8]>(), b in any::<[u64; 8]>()) {
            let packed_a = PackedGoldilocksAVX512::from_u64_array(a);
            let packed_b = PackedGoldilocksAVX512::from_u64_array(b);
            let result = (packed_a - packed_b).to_array();
            for i in 0..WIDTH {
        ...
        #[test]
        fn mul_matches_scalar(a in any::<[u64; 8]>(), b in any::<[u64; 8]>()) {
            let packed_a = PackedGoldilocksAVX512::from_u64_array(a);
            let packed_b = PackedGoldilocksAVX512::from_u64_array(b);
            let result = (packed_a * packed_b).to_array();
            for i in 0..WIDTH {
        ...
        #[test]
        fn neg_matches_scalar(a in any::<[u64; 8]>()) {
            let packed_a = PackedGoldilocksAVX512::from_u64_array(a);
        ...
        #[test]
        fn square_matches_scalar(a in any::<[u64; 8]>()) {
            let packed_a = PackedGoldilocksAVX512::from_u64_array(a);
