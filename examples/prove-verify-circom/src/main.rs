...
/// This example demonstrates how to prove and verify a Circom circuit using the Groth16 prover.
///
/// You can run with:
///
/// ```sh
/// cargo run --package prove-verify-circom --bin prove-verify-circom
/// ```
fn main() {
