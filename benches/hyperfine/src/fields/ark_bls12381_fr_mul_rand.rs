//! Arkworks BLS12-381 scalar field (Fr) multiplication benchmark with random sampling
...
// Simple LCG for reproducible random numbers (same as lambdaworks benchmark)
