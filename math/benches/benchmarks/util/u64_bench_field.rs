...
pub struct U64BenchField<const MODULUS: u64>;

impl<const MODULUS: u64> IsField for U64BenchField<MODULUS> {
    type BaseType = u64;
...
impl<const MODULUS: u64> IsTwoAdicField for U64BenchField<MODULUS> {
