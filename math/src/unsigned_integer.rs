use crypto_bigint::{Checked, NonZero, Word, U384, U768};
...
impl Rem for UnsignedInteger384 {
    ...
    fn rem(self, rhs: Self) -> Self::Output {
        Self {
            value: self.value % NonZero::new(rhs.value).unwrap(),
        }
    }
}
...
impl Sub for UnsignedInteger384 {
    ...
    fn sub(self, rhs: Self) -> Self::Output {
        assert!(
            ...
            "UnsignedInteger384 subtraction overflow"
        );
        Self {
            value: (Checked::new(self.value) - Checked::new(rhs.value))
                .0
                .unwrap(),
        }
    }
...
impl UnsignedInteger384 {
    ...
    pub fn add_mod(
        a: &UnsignedInteger384,
        b: &UnsignedInteger384,
        m: &UnsignedInteger384,
    ) -> UnsignedInteger384 {
        Self {
            value: a.value.add_mod(&b.value, &m.value),
        }
    }
