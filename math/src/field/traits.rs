...
pub trait HasDefaultTranscript: IsField {
    /// This function should truncate the sampled bits to the quantity required to represent the order of the base field
    /// and return a field element if the resulting number is less than the modulus, or None if the sampled number
