...
impl IsField for Degree12ExtensionField {
    ...
    fn mul(a: &Self::BaseType, b: &Self::BaseType) -> Self::BaseType {
        ...
        let b1 = &b[1];
        [
            a0 * b0 + a1 * mul_fp6_by_nonresidue(b1),
    ...
    fn square(a: &Self::BaseType) -> Self::BaseType {
        ...
        [
            (a0 - a1) * (a0 - mul_fp6_by_nonresidue(a1)) + a0 * a1 + a0 * mul_fp6_by_nonresidue(a1),
            a0 * a1 + a0 * a1,
        ]
    }
    ...
    fn inv(a: &Self::BaseType) -> Result<Self::BaseType, FieldError> {
        ...
        let a1 = &a[1];
        Ok([
            a0 * (a0.square() - mul_fp6_by_nonresidue(&a1.square()))
                .inv()
                .unwrap(),
            -a1 * (a0.square() - mul_fp6_by_nonresidue(&a1.square()))
                .inv()
                .unwrap(),
        ])
    }
