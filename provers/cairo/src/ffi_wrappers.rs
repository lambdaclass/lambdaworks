...
#[no_mangle]
pub extern "C" fn verify_cairo_proof_ffi_100_bits(proof_bytes: &[u8;MAX_PROOF_SIZE], real_len: usize) -> bool {
...
#[cfg(test)] 
mod tests {
    use crate::ffi_wrappers::verify_cairo_proof_ffi_100_bits;
