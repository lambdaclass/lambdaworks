...
impl<F> TransitionConstraint<F> for FibTransition1<F>
where
...
impl<F> TransitionConstraint<F> for FibTransition2<F>
where
    F: IsFFTField + Send + Sync,
{
    fn degree(&self) -> usize {
    ...
    F: IsFFTField + Send + Sync + 'static,
{
    ...
    fn new(
        ...
        let constraints: Vec<Box<dyn TransitionConstraint<Self::Field>>> = vec![
